...
- 您**不应该**使用本插件播放任何不合适的动作/动画(包括但不限于色情、暴力等违反法律法规或引起社区不适的内容)。
- 您**不应该**在再分发本插件时进行任何形式的收费(包括但不限于付费获取下载链接、付费加群、付费获取高速下载链接等)。
- 您**可以**在遵循 AGPL-3.0 license 的前提下任意使用、修改、免费再分发本插件。
- 任何人在任何平台售卖本插件的行为均为**欺诈与倒卖**。如果您是付费购买获取的，**您已经被骗了，请立刻向平台发起投诉并申请退款**。
- 使用本插件即代表您已同意本页面的所有条款。
